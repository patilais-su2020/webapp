...
import { deleteallimagesfroms3,deleteallimages } from '../apis/imagesapi'
    ...
    function deleteEntryConfirm(book, index) {
        ...
        deletebook(book).then(res => {
            if (res.status === 200) {
                ...
                deleteallimagesfroms3(imagekeys).then(res => {
                    if(res.status===200){
                        deleteallimages(book).then(res => {
                            if(res.status!=200){
                                alert("Error deleting book from table")
                            }
                        })
                    } else {
            ...
            return (
                <div key={index} className="col-lg-6 col-md-8 col-sm-24">
                    <div className="card  displaybooks">
                        ...
                        <div id={"carouselExampleControls"+index} className="carousel slide" data-ride="carousel">
                            ...
                            <a className="carousel-control-prev" href={"#carouselExampleControls"+index} role="button" data-slide="prev">
                                <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span className="sr-only">Previous</span>
                            </a>
                            <a className="carousel-control-next" href={"#carouselExampleControls"+index} role="button" data-slide="next">
